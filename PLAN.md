...
Migration is capability-scoped. the provider keeps a runtime legacy fallback until the replacement capability passes dual-run parity. Each wave is an atomic scoped commit and can be reverted independently.
