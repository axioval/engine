...
- Release candidate `0.1.3`: source-neutral `LinearQuantityService` and the `ShelfCapacity` capability -- the first ADR 0004 decomposition, splitting a measured shelf run from the policy that judges it.
