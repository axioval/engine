...
- a constant: `target_number`, `target_text` or `target_boolean`;
...
Most names and numbers these rules read are attributes of the object, not properties; see [attribute sets](./ir.md#attribute-sets).
